...
public class PlayerData : ScriptableObject
{
    ...
    public Vector2 dodgeEndSpeed;
    public float dodgeResetTime;
    [Space(5)]
    public float parryResetTime = 0.3f; //0.3f

    [Header("Attack")]
    public int attackDamage;
    public int maxAttackComboHit;
    public float attackRate;
    public float attackInputBufferTime;
    public int heavyAttackDamage;
    public int circleAttackDamage;
    ...
    public float SuperArmorTime; //0.2f

    [Space(5)]
    [Header("Hurt")]
    public float HurtResetTime = 0.2f; //0.2f
    public float StunResetTime = 1f; //1f
